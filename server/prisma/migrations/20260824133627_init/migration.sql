...
CREATE TABLE "Ticket" (
    ...
    "firstResponseAtRiskAt" TIMESTAMP(3) NOT NULL,
    "resolutionAtRiskAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Ticket_firstResponseAt_firstResponseDueAt_idx" ON "Ticket"("firstResponseAt", "firstResponseDueAt");

-- CreateIndex
CREATE INDEX "Ticket_resolvedAt_resolutionDueAt_idx" ON "Ticket"("resolvedAt", "resolutionDueAt");
